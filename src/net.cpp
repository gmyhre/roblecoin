...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Roblecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"roblecointools.com", "dnsseed.roblecointools.com"},
    {"roblecoinpool.org", "dnsseed.roblecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"roblecointools.com", "testnet-seed.roblecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Roblecoin is probably already running."), addrBind.ToString().c_str());
        else
